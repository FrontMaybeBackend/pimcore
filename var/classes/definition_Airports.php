 ...
 * - name [textarea]
 * - airType [input]
 * - latitudeDeg [geopoint]
 * - longitudeDeg [numeric]
 * - elevationFt [quantityValue]
 * - continent [input]
 * - isoCountry [countrymultiselect]
 * - isoRegion [input]
 * - municipality [input]
 * - gpsCode [input]
 * - iataCode [input]
 ...
 * - wikipediaLink [link]
 * - keywords [input]
 * - scheduledService [booleanSelect]
 */
